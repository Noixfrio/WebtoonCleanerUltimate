...
*   **Downloads Diretos (Hugging Face):** [Windows (v0.9.9-beta.33-win)](https://huggingface.co/samyuush/WebtoonCleanerUltimate/resolve/main/binaries/Toonix-v0.9.9-beta.33-win-windows.zip) | [Linux (v0.9.9-beta.33-lin)](https://huggingface.co/samyuush/WebtoonCleanerUltimate/resolve/main/binaries/Toonix-v0.9.9-beta.33-lin-linux.zip)

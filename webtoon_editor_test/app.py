...
# Garantir que o diretório raiz do projeto esteja no path para encontrar o módulo 'launcher'
...
if __name__ == "__main__":
    import sys
    # Garantir que o diretório pai esteja no path para imports relativos funcionarem se rodado diretamente
    parent_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    if parent_dir not in sys.path:
        sys.path.insert(0, parent_dir)
        
    print("Iniciando Editor Pro na porta 5002...")
